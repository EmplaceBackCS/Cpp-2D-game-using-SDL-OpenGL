...
RightBullets::RightBullets(glm::vec2 pos, glm::vec2 direction, float speed, int lifeTime, int size) : 
	Bullets(
		pos, 
		direction, 
		speed, 
...
void RightBullets::draw(CSGengine::SpriteBatch& spriteBatch)
{
	...
	static CSGengine::GLTexture texture = CSGengine::ResourceManager::getTexture("Textures/Bullet_000.png");
